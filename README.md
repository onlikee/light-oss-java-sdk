...
Go/Gin API; it is not an Amazon S3 client. Version 0.3.0 covers all 39 documented OpenAPI
...
The 0.3.x line treats published public signatures as stable. Public APIs are not removed or
